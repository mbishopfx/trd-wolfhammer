  ...
  return (
    <div className="bg-emergency text-white py-2 px-4 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <button
          onClick={handleCall}
          className="flex items-center gap-2 bg-white text-emergency px-4 py-1.5 rounded-full font-bold text-sm hover:bg-gray-100 transition-all transform hover:scale-105 animate-pulse-emergency"
        >
